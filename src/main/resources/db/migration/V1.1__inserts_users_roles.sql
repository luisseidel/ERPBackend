...
INSERT INTO public.user_role(id, user_id, role_id)
VALUES (nextval('seq_user_role'), 2, 2);
...
(nextval('seq_permission'), 'USUARIO', 'Permissões relacionadas a Usuários'),
...
(nextval('seq_role_permission'), 1, 1, true, true, true, true),  -- CIDADE
(nextval('seq_role_permission'), 1, 2, true, true, true, true),  -- ESTADO
(nextval('seq_role_permission'), 1, 3, true, true, true, true),  -- ENDERECO
(nextval('seq_role_permission'), 1, 4, true, true, true, true),  -- MENU
(nextval('seq_role_permission'), 1, 5, true, true, true, true),  -- ROLE
(nextval('seq_role_permission'), 1, 6, true, true, true, true),  -- USUARIO
...
insert into public.role_permission(id, role_id, permission_id, consultar, adicionar, editar, excluir) values
(nextval('seq_role_permission'), 2, 1, true, false, true, false),  -- CIDADE
(nextval('seq_role_permission'), 2, 2, true, false, true, false);  -- ESTADO