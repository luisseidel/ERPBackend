...
VALUES (1, 'Brazil', 'Brasil', 'BR'),
       ...
       (254, 'Saint Barthélemy', 'Coletividade de São Bartolomeu', 'BL'),
       (255, 'Curaçao', 'Curaçao', 'CW'),
       (256, 'Saint Martin', 'São Martinho, Ilha de (Parte Francesa)', 'SM'),
       ...
       (262, 'Saint Martin', 'São Martinho, Ilha de (Parte Holandesa)', 'SM'),
       (263, 'Terres Australes et Antarctiques Françaises', 'Terras Austrais e Antárcticas Francesas', 'TF');

ALTER SEQUENCE public.seq_paises RESTART 999;